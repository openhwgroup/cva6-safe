...
# Author: Daniel Gracia Pérez

# Program Genesys2 FPGA board connected to $HW_SERVER_URL with bitstream ../work-fpga/cva6_safe_xilinx.bit
...
set_property PROGRAM.FILE {../work-fpga/cva6_safe_xilinx.bit} [get_hw_device xc7k325t_0]
