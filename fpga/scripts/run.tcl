...
if {$::env(BOARD) eq "genesys2"} {
  add_files -fileset constrs_1 -norecurse \
    $::env(CVA6_REPO_DIR)/corev_apu/fpga/constraints/genesys-2.xdc
} elseif {$::env(BOARD) eq "kc705"} {
  add_files -fileset constrs_1 -norecurse \
    $::env(CVA6_REPO_DIR)/corev_apu/fpga/constraints/kc705.xdc
} elseif {$::env(BOARD) eq "vc707"} {
  add_files -fileset constrs_1 -norecurse \
    $::env(CVA6_REPO_DIR)/corev_apu/fpga/constraints/vc707.xdc
} else {
  exit 1
}
...
#   "../../core/include" \
# } [current_fileset]
# There is no axi_sd_bridge folder, we remove it
set_property include_dirs { \
  "../cva6/vendor/pulp-platform/common_cells/include" \
  "../cva6/vendor/pulp-platform/axi/include" \
  "../cva6/core/cache_subsystem/hpdcache/rtl/include" \
...
if {$::env(BOARD) eq "genesys2"} {
  read_verilog -sv { \
    ../cva6/corev_apu/fpga/src/genesysii.svh \
    ../cva6/vendor/pulp-platform/common_cells/include/common_cells/registers.svh}
  set file $::env(CVA6_REPO_DIR)/corev_apu/fpga/src/genesysii.svh
  set registers $::env(CVA6_REPO_DIR)/vendor/pulp-platform/common_cells/include/common_cells/registers.svh
} elseif {$::env(BOARD) eq "kc705"} {
  read_verilog -sv {src/kc705.svh ../../vendor/pulp-platform/common_cells/include/common_cells/registers.svh}
  set file "src/kc705.svh"
  set registers "../../vendor/pulp-platform/common_cells/include/common_cells/registers.svh"
