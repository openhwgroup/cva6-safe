 ...
 * Daniel Gracia Pérez <daniel.gracia-perez@thalesgroup.com> - dgptha on github.com
 */
`timescale 1ns/1ps
   ...
   class debug_mode_if_t;
	...
	task load_L2_ariane(
      ...
      task test_discover_harts(
         ...
         // assert (hartcount === cva6_apu_config_pkg::CVA6APUConfigNumCores)
         assert (
            (cva6_safe_apu_config_pkg::DCLS_MODE ===
                cva6_safe_dcls_types_pkg::LS &&
             hartcount === cva6_safe_apu_config_pkg::NUM_DCLS) ||
            (cva6_safe_apu_config_pkg::DCLS_MODE ===
                cva6_safe_dcls_types_pkg::DC &&
             hartcount === (cva6_safe_apu_config_pkg::NUM_DCLS * 2)))
             else begin
         ...
         $display("[TB] %d harts discovered", hartcount);
