...
Contributors are encouraged, but not required, to be a [member](https://www.openhwfoundation.org/membership/) of the OpenHW Foundation.

### The OpenHW CVA6 Project

This repository is part of the Eclipse Foundations's [OpenHW CVA6 Project](https://projects.eclipse.org/projects/openhw.cva6).
Below are guidelines to help the CVA6 team accept new contributions:
...
- Get in touch early with the CVA6 team, present your initiative, get feedback, synchronize with the team...
    ...
    * If you do not know how to contact us already, open an issue in GitHub.

- Specific recommendations:
    * Your contribution shall be optional and fully disabled by default so that projects already using CVA6 are not impacted (no functionality change, no extra silicon...).
    * To configure your contribution, System Verilog top-level parameters are preferred.
        - Synchronize with CVA6 team if you have questions about how to do this effectively.
...
Bug fixes are always welcome. You can either:
* Submit a pull request for an existing issue.  In this case please refer to the Issue you are fixing.
* Open _both_ a new Issue and Pull-Request.  (It is useful to have a description of the Issue seperate from the Pull-Request.)

## The Mechanics
1. From GitHub: [fork](https://help.github.com/articles/fork-a-repo/) the [cva6-safe](https://github.com/openhwgroup/cva6-safe) repository
